...
if (!$trainer) {
    echo "Không tìm thấy dữ liệu HLV.";
    exit;
}
?>
<!DOCTYPE html>
    ...
    <main class="main-content">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <form method="post" action="?c=trainers&a=update">
                    <input type="hidden" name="id" value="<?= $trainer->MANV ?>">
                    ...
                    <div class="form-layout">
                        <div>
                            <div class="form-group">
                                ...
                                <input type="text"
                                       name="hoten"
                                       class="form-control"
                                       value="<?= htmlspecialchars($trainer->HOTEN) ?>"
                                       required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       name="sdt"
                                       class="form-control"
                                       value="<?= htmlspecialchars($trainer->SDT) ?>"
                                       required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"
                                       name="ngayvaolam"
                                       class="form-control"
                                       value="<?= htmlspecialchars($trainer->NGAYVAOLAM) ?>"
                                       required>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <textarea name="chuyenmon"
                                          class="form-control"
                                          rows="4"><?= htmlspecialchars($trainer->MOTA ?? '') ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="trangthai" class="form-control">
                                    <option value="1" <?= $trainer->TRANGTHAI ? 'selected' : '' ?>>Đang làm</option>
                                    <option value="0" <?= !$trainer->TRANGTHAI ? 'selected' : '' ?>>Ngưng</option>
                                </select>
                            </div>
                        </div>
                    </div>
