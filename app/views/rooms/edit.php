...
<main class="main-content">
    <div class="content">
        <div class="page-header">
            ...
            <p>Cập nhật thông tin phòng/sân trong trung tâm</p>
        </div>
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                ...
                                <option value="Yoga Studio" selected>Yoga Studio</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" 
                                      class="form-control" 
                                      rows="3"
                                      placeholder="Ghi chú thêm (nếu có)">Ưu tiên cho lớp yoga buổi sáng.</textarea>
                        </div>
                    </div>
                </div>
