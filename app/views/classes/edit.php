...
if (!$class) {
    echo "Không tìm thấy dữ liệu lớp.";
    exit;
}
?>
<!DOCTYPE html>
    ...
    <main class="main-content">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <p>Cập nhật thông tin lớp tập luyện.</p>
            </div>
            ...
            <div class="card">
                ...
                <form method="post" action="?c=classes&a=update">
                    <input type="hidden" name="id" value="<?= $class->MALOP ?>">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description"
                                          class="form-control"
                                          rows="4"><?= htmlspecialchars($class->MOTA ?? '') ?></textarea>
                            </div>
                        </div>
